...
<html lang="en">
  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{asset('skydash-free/dist/pages/ui-features/buttons.html') }}">Buttons</a></li>
          <li class="nav-item"> <a class="nav-link" href="{{asset('skydash-free/dist/pages/ui-features/dropdowns.html') }}">Dropdowns</a></li>
          <li class="nav-item"> <a class="nav-link" href="{{asset('skydash-free/dist/pages/ui-features/typography.html') }}">Typography</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      ...
      <div class="collapse" id="form-elements">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"><a class="nav-link" href="{{asset('skydash-free/dist/pages/forms/basic_elements.html') }}">Basic Elements</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="tables">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{asset('skydash-free/dist/pages/tables/basic-table.html') }}">Basic table</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      ...
      <div class="collapse" id="icons">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{asset('skydash-free/dist/pages/icons/mdi.html') }}">Mdi icons</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      ...
      <div class="collapse" id="auth">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{asset('skydash-free/dist/pages/samples/login.html') }}"> Login </a></li>
          <li class="nav-item"> <a class="nav-link" href="{{asset('skydash-free/dist/pages/samples/register.html') }}"> Register </a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      ...
      <div class="collapse" id="error">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{asset('skydash-free/dist/pages/samples/error-404.html') }}"> 404 </a></li>
          <li class="nav-item"> <a class="nav-link" href="{{asset('skydash-free/dist/pages/samples/error-500.html') }}"> 500 </a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="icon-data-list">
                      <li>
                        <div class="d-flex">
                          <img src="{{asset('skydash-free/dist/assets/images/faces/face1.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{asset('skydash-free/dist/assets/images/faces/face2.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{asset('skydash-free/dist/assets/images/faces/face3.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{asset('skydash-free/dist/assets/images/faces/face4.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{asset('skydash-free/dist/assets/images/faces/face5.jpg') }}" alt="user">
                          <div>
  ...
  <div class="d-sm-flex justify-content-center justify-content-sm-between">
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="{{asset('skydash-free/dist/assets/vendors/js/vendor.bundle.base.j') }}'"></script>
    <!-- endinject -->
